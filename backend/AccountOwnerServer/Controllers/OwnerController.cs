...
public class OwnerController : ControllerBase
{
    ...
    public IActionResult CreateOwner([FromBody] OwnerForCreationDto owner)
    {
        try
        {
            ...
            {
                _logger.LogError("Objeto owner enviado é invalido");
    ...
    public IActionResult DeleteOwner(Guid id)
    {
        try
        {
            ...
            {
                _logger.LogError($"O owner com id: {id}, não pode ser excluído, pois possui contas relacionadas. Exclua as contas primeiro.");
